...
def generate_cdm_data_for_course(course_id):
    ...
    for dt in rrule(DAILY, dtstart=start_date, until=end_date):
        ...
        average_progress = float('{0:.2f}'.format(random()))
...
# def generate_cdm_data():
#     data = []
#     for rec in COURSE_OVERVIEW_DATA:
#         data += generate_cdm_data_for_course(rec['id'])

# COURSE_DAILY_METRICS_DATA = generate_cdm_data()
